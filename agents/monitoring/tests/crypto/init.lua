...
local SELF_SIGNED_CERT = [[
-----BEGIN CERTIFICATE-----

Lfg5IvWXbQgakHQ31oBg24/Jkjd/LFKXjIpx0dh2gRdtTKEFDlU+8o/t
-----END CERTIFICATE-----
]]
...
exports['test_no_shared_state'] = function(test, asserts)
  ...
  server:on('error', function(err)
    p(err)
    asserts.ok(false, 'server err')
  end)
  server:listen(10010, '127.0.0.1')

  local conn = tls.connect(10010, '127.0.0.1', client_options, function(err, cleartext)
    kpub = crypto.pkey.from_pem(RSA_PUBLIC_KEY)
    local d = crypto.digest.new("sha256")
    d:update('hewro')
    local verified = d:final("I'm a sig!", kpub)
    cleartext:write('ok')
    test.done()
  end)
